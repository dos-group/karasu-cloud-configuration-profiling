...
from preparation.loader_scout import _machine_name_to_power_characteristics, _resolve_costs
...
class WorkloadTask(BaseInformationModel):
    ...
    @staticmethod
    def lower_energy_bound(runtime: float, *args, **kwargs):
        _, p_max = _machine_name_to_power_characteristics("R4XXL")
        energy: float = p_max * runtime / 3600
        return ProcessedWorkloadModel.construct(energy=energy, runtime=runtime)
