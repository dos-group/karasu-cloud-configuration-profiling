    ...
    for num_tasks in [1, 5, 9]:
        for opt_class, opt_name in [
            ...
            strategies = [strategy_cls(artifact_source_path, num_tasks)
                          for strategy_cls in [ExactSameWorkloadSelectionStrategy,
                                               AlmostExactSameWorkloadSelectionStrategy]]
            ...
            multiple_experiment.run("INFO", f"RQ1_{opt_name.lower()}")
