                ...
                for percentile in self.experiment_config.percentiles:
                    for optimizer_class, optimizer_class_sub in self.optimization_classes:
                        ...
                        exp_config: dict = {
                            ...
                            "seed": seed_val,
                            "num_objectives": 2,
                            "num_init": self.experiment_config.num_initial_random_points,
                            "normalize": False,
...
if __name__ == '__main__':
    ...
    for opt_class, opt_name in [
        (KarasuOptimizerTASK, "CherryPick"),
        (KarasuOptimizerTASK, "Arrow")
    ]:
        multiple_experiment: SooExperiment = SooExperiment("scout_multiple",
                                                           experiment_config=ExperimentConfig(
                                                               ...
                                                               num_profilings=10)) \
            .set_experiment_name(f"multiple_moo_{opt_name.lower()}") \
