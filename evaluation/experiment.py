...
from optimization.methods.karasu.selection_strategies import SelectionStrategy
...
class Experiment:
    def __init__(self, scope: str,
        ...
        self.selection_strategies: List[SelectionStrategy] = []
    ...
    def set_selection_strategies(self, selection_strategies: List[SelectionStrategy]):
